...
public class Worktime {
    ...
    public Worktime(int wt_id, int wt_comp_id, long wt_startdate, long wt_enddate, String wt_rem, int wt_week) {
        this._wt_id = wt_id;
    ...
    public Worktime(int wt_comp_id, long wt_startdate, long wt_enddate, String wt_rem, int wt_week) {
        this._wt_comp_id = wt_comp_id;
        this._wt_startdate = wt_startdate;
        this._wt_enddate = wt_enddate;
        this._wt_rem = wt_rem;
